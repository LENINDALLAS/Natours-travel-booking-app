...
var displayMap = function displayMap(locations) {
  var map = new ol.Map({
    ...
    view: new ol.View({
      center: ol.proj.fromLonLat(_toConsumableArray(locations[0].coordinates)),
      zoom: 7
    }),
  ...
  locations.forEach(function (location) {
    var marker = new ol.Feature(new ol.geom.Point(ol.proj.fromLonLat(_toConsumableArray(location.coordinates))));
...
var stripe = Stripe('pk_test_51LJyARSITRzDtMl6QQJBCMC9NerajqjgOMZyrFtYLYYwYKzK7V2fwGhrHIlLtm6cNDL3zffnjDCvMAo2I1Gm9koK00y8RU0Scu');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "http://localhost:3000/api/v1/bookings/".concat(tourId),
              headers: {
                // "Content-Type": "multipart/form-data",
                Authorization: 'Bearer ' + document.cookie.split('token=')[1]
              }
...
var openLayers = document.getElementById('map');
...
if (openLayers) {
  var locations = JSON.parse(openLayers.dataset.locations);
...
if (updatePasswordForm) {
  updatePasswordForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var oldPassword, password, passwordConfirm, data;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              (0, _alert.showAlert)('error', "Password field is required");
            ...
            case 10:
              ...
              (0, _alert.showAlert)('error', "New password and Confirm password do not match");
              return _context.abrupt("return");
